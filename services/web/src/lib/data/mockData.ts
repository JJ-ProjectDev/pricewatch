...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description:
      'A flagship-tier graphics card built for 4K gaming and heavy creative workloads, with 16GB of high-bandwidth memory and a triple-fan cooling shroud that stays quiet under sustained load.',
